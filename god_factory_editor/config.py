...
DEFAULTS = {
    ...
    "automation_noise_floor_db": -38.0,
    "voice_band_low_hz": 180.0,
    ...
    "shortcuts": {
        ...
        "preview_effects": "Ctrl+Shift+P",
        "set_work_start": "Ctrl+Alt+1",
        "set_work_end": "Ctrl+Alt+2",
        "clear_work_area": "Ctrl+Alt+0",
        "exclude_selected": "Ctrl+Alt+X",
        "toggle_proxy": "Ctrl+P",
        "loop_clip": "L",
        "rename": "F2",
        "zoom_in": "Ctrl+=",
