...
class SettingsDialog(QDialog):
    ...
    def _build_keys_tab(self) -> QWidget:
        ...
        labels = {
            ...
            "preview_effects":   "Preview Selected Clip Effects",
            "set_work_start":    "Set Work Start At Playhead",
            "set_work_end":      "Set Work End At Playhead",
            "clear_work_area":   "Clear Work Area + Excluded Zones",
            "exclude_selected":  "Exclude Selected Clips From Automation",
